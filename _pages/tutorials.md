...
- [Download bash script]( {{ site.baseurl }}/assets/scripts/edit_restart_file_index_for_plotting.sh ) [[view code]]({{ site.baseurl }}/assets/scripts/edit_restart_file_index_for_plotting.txt )
...
- [Download bash script]( {{ site.baseurl }}/assets/scripts/remove_redundant_info.sh ) [[view code]]({{ site.baseurl }}/assets/scripts/remove_redundant_info.txt )
