...
<section class="web-intro web-intro-standalone" aria-labelledby="web-intro-title">
  ...
  <nav class="web-node-map" aria-label="Featured site sections">
    <a class="web-node node-about is-core" href="{{ site.baseurl }}/about" data-node-label="About">
      <span>About</span>
    </a>
